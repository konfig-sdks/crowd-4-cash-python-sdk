...
class BaseApi(api_client.Api):
    ...
    def _submit_loan_application_mapped_args(
        self,
    ...
    async def _asubmit_loan_application_oapg(
        self,
    ...
    def _submit_loan_application_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class SubmitLoanApplicationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asubmit_loan_application(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._submit_loan_application_mapped_args(
        )
        return await self._asubmit_loan_application_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def submit_loan_application(
        ...
        return self._submit_loan_application_oapg(
            body=args.body,
        )

class SubmitLoanApplication(BaseApi):
    ...
    async def asubmit_loan_application(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.asubmit_loan_application(
            **kwargs,
        )
        if validate:
    ...
    def submit_loan_application(
        ...
        raw_response = self.raw.submit_loan_application(
        )
        if validate:
            return ApplicationResultPydantic(**raw_response.body)
        return api_client.construct_model_instance(ApplicationResultPydantic, raw_response.body)
