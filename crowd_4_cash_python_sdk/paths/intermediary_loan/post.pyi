...
from crowd_4_cash_python_sdk.model.intermediary_loan_application import IntermediaryLoanApplication as IntermediaryLoanApplicationSchema
...
from crowd_4_cash_python_sdk.type.intermediary_loan_application import IntermediaryLoanApplication
from crowd_4_cash_python_sdk.type.application_result import ApplicationResult

from ...api_client import Dictionary
from crowd_4_cash_python_sdk.pydantic.intermediary_loan_application import IntermediaryLoanApplication as IntermediaryLoanApplicationPydantic
...
# body param
SchemaForRequestBodyApplicationJson = IntermediaryLoanApplicationSchema


request_body_intermediary_loan_application = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _submit_partner_loan_application_mapped_args(
        self,
        serial_number: str,
        identification_number: str,
        partner_id: typing.Optional[int] = None,
        purchase_item: typing.Optional[typing.Optional[str]] = None,
        item_status: typing.Optional[typing.Optional[str]] = None,
        item_name: typing.Optional[typing.Optional[str]] = None,
        ...
        item_market_value: typing.Optional[typing.Union[int, float]] = None,
        manufacture_date: typing.Optional[typing.Optional[str]] = None,
        first_registration: typing.Optional[typing.Optional[str]] = None,
        mileage: typing.Optional[typing.Optional[str]] = None,
        item_certificate: typing.Optional[typing.Optional[str]] = None,
        rental_amount: typing.Optional[typing.Union[int, float]] = None,
        ...
        if manufacture_date is not None:
            _body["manufactureDate"] = manufacture_date
        if first_registration is not None:
            _body["firstRegistration"] = first_registration
        if mileage is not None:
            _body["mileage"] = mileage
        if item_certificate is not None:
            _body["itemCertificate"] = item_certificate
    ...
    async def _asubmit_partner_loan_application_oapg(
        self,
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_intermediary_loan_application.serialize(body, content_type)
    ...
    def _submit_partner_loan_application_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class SubmitPartnerLoanApplicationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asubmit_partner_loan_application(
        self,
        serial_number: str,
        identification_number: str,
        partner_id: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._submit_partner_loan_application_mapped_args(
        ...
        return await self._asubmit_partner_loan_application_oapg(
            body=args.body,
            **kwargs,
        )
    
    def submit_partner_loan_application(
        self,
        serial_number: str,
        identification_number: str,
        partner_id: typing.Optional[int] = None,
        ...
        return self._submit_partner_loan_application_oapg(
            body=args.body,
        )

class SubmitPartnerLoanApplication(BaseApi):
    ...
    async def asubmit_partner_loan_application(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.asubmit_partner_loan_application(
            serial_number=serial_number,
            identification_number=identification_number,
            partner_id=partner_id,
            purchase_item=purchase_item,
    ...
    def submit_partner_loan_application(
        ...
        raw_response = self.raw.submit_partner_loan_application(
            serial_number=serial_number,
            identification_number=identification_number,
            partner_id=partner_id,
            purchase_item=purchase_item,
